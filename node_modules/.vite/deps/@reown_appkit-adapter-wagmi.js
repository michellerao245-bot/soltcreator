...
import "./chunk-JVZZADJ2.js";
import "./chunk-37H3ENLV.js";
import "./chunk-T4GXF2SB.js";
import {
  parseUnits
} from "./chunk-ZTIIAGJD.js";
import {
  SwitchChainError,
...
async function getSafeConnector(connectors) {
  if (CoreHelperUtil.isSafeApp()) {
    const { safe } = await import("./exports-NAGI77UB.js");
...
async function getBaseAccountConnector(connectors) {
  try {
    const { baseAccount } = await import("./exports-NAGI77UB.js");
...
async function getCoinbaseConnector(connectors) {
  try {
    const { coinbaseWallet } = await import("./exports-NAGI77UB.js");
