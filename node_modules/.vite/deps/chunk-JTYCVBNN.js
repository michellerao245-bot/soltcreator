...
} from "./chunk-EWEKUDXI.js";
import {
  createRef,
  ref
} from "./chunk-SD5H53HM.js";
import {
  LitElement,
  classMap,
  css,
...
var require_dayjs_min = __commonJS({
  "node_modules/@web3modal/common/node_modules/dayjs/dayjs.min.js"(exports, module) {
    !function(t2, e2) {
      ...
      "use strict";
      var t2 = 1e3, e2 = 6e4, n2 = 36e5, r = "millisecond", i2 = "second", s3 = "minute", u = "hour", a = "day", o = "week", c3 = "month", f2 = "quarter", h3 = "year", d2 = "date", l3 = "Invalid Date", $ = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, y3 = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, M = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(t3) {
        ...
        var r2 = 12 * (n3.year() - e3.year()) + (n3.month() - e3.month()), i3 = e3.clone().add(r2, c3), s4 = n3 - i3 < 0, u2 = e3.clone().add(r2 + (s4 ? -1 : 1), c3);
        return +(-(r2 + (n3 - i3) / (s4 ? i3 - u2 : u2 - i3)) || 0);
      }, a: function(t3) {
        return t3 < 0 ? Math.ceil(t3) || 0 : Math.floor(t3);
      }, p: function(t3) {
        return { M: c3, y: h3, w: o, d: a, D: d2, h: u, m: s3, s: i2, ms: r, Q: f2 }[t3] || String(t3 || "").toLowerCase().replace(/s$/, "");
      }, u: function(t3) {
        return void 0 === t3;
      } }, g2 = "en", D = {};
      D[g2] = M;
      ...
      var _2 = function() {
        ...
        return m3.parse = function(t3) {
          this.$d = function(t4) {
            ...
            if ("string" == typeof e3 && !/Z$/i.test(e3)) {
              ...
              if (r2) {
                ...
                return n3 ? new Date(Date.UTC(r2[1], i3, r2[3] || 1, r2[4] || 0, r2[5] || 0, r2[6] || 0, s4)) : new Date(r2[1], i3, r2[3] || 1, r2[4] || 0, r2[5] || 0, r2[6] || 0, s4);
              }
            }
            return new Date(e3);
          }(t3), this.init();
          ...
          var n3, o2 = b2.p(t3), f3 = "set" + (this.$u ? "UTC" : ""), l4 = (n3 = {}, n3[a] = f3 + "Date", n3[d2] = f3 + "Date", n3[c3] = f3 + "Month", n3[h3] = f3 + "FullYear", n3[u] = f3 + "Hours", n3[s3] = f3 + "Minutes", n3[i2] = f3 + "Seconds", n3[r] = f3 + "Milliseconds", n3)[o2], $2 = o2 === a ? this.$D + (e3 - this.$W) : e3;
          if (o2 === c3 || o2 === h3) {
            var y4 = this.clone().set(d2, 1);
            y4.$d[l4]($2), y4.init(), this.$d = y4.set(d2, Math.min(this.$D, y4.daysInMonth())).$d;
          } else l4 && this.$d[l4]($2);
          ...
          var d3, l4 = this;
          r2 = Number(r2);
          var $2 = b2.p(f3), y4 = function(t3) {
            var e3 = O2(l4);
            return b2.w(e3.date(e3.date() + Math.round(t3 * r2)), l4);
          };
          if ($2 === c3) return this.set(c3, this.$M + r2);
          if ($2 === h3) return this.set(h3, this.$y + r2);
          if ($2 === a) return y4(1);
          if ($2 === o) return y4(7);
          var M3 = (d3 = {}, d3[s3] = e2, d3[u] = n2, d3[i2] = t2, d3)[$2] || 1, m4 = this.$d.getTime() + r2 * M3;
          return b2.w(m4, this);
          ...
          var r2 = t3 || "YYYY-MM-DDTHH:mm:ssZ", i3 = b2.z(this), s4 = this.$H, u2 = this.$m, a2 = this.$M, o2 = n3.weekdays, c4 = n3.months, f3 = n3.meridiem, h4 = function(t4, n4, i4, s5) {
            return t4 && (t4[n4] || t4(e3, r2)) || i4[n4].slice(0, s5);
          }, d3 = function(t4) {
          ...
          return r2.replace(y3, function(t4, r3) {
            return r3 || function(t5) {
              switch (t5) {
                ...
                case "MMM":
                  return h4(n3.monthsShort, a2, c4, 3);
                case "MMMM":
                  return h4(c4, a2);
                case "D":
                  return e3.$D;
                ...
                case "d":
                  return String(e3.$W);
                case "dd":
                  return h4(n3.weekdaysMin, e3.$W, o2, 2);
                case "ddd":
                  return h4(n3.weekdaysShort, e3.$W, o2, 3);
                case "dddd":
                  return o2[e3.$W];
                case "H":
                  return String(s4);
          ...
          var $2, y4 = this, M3 = b2.p(d3), m4 = O2(r2), v3 = (m4.utcOffset() - this.utcOffset()) * e2, g3 = this - m4, D2 = function() {
            return b2.m(y4, m4);
          };
          switch (M3) {
            case h3:
          ...
          if (!t3) return this.$L;
          var n3 = this.clone(), r2 = w2(t3, e3, true);
      ...
      return O2.prototype = k2, [["$ms", r], ["$s", i2], ["$m", s3], ["$H", u], ["$W", a], ["$M", c3], ["$y", h3], ["$D", d2]].forEach(function(t3) {
        k2[t3[1]] = function(e3) {
  ...
  "node_modules/@web3modal/common/node_modules/dayjs/plugin/relativeTime.js"(exports, module) {
    !function(r, e2) {
      ...
      return function(r, e2, t2) {
        r = r || {};
        var n2 = e2.prototype, o = { future: "in %s", past: "%s ago", s: "a few seconds", m: "a minute", mm: "%d minutes", h: "an hour", hh: "%d hours", d: "a day", dd: "%d days", M: "a month", MM: "%d months", y: "a year", yy: "%d years" };
        function i2(r2, e3, t3, o2) {
          return n2.fromToBase(r2, e3, t3, o2);
        }
        t2.en.relativeTime = o, n2.fromToBase = function(e3, n3, i3, d3, u) {
          for (var f2, a, s3, l3 = i3.$locale().relativeTime || o, h3 = r.thresholds || [{ l: "s", r: 44, d: "second" }, { l: "m", r: 89 }, { l: "mm", r: 44, d: "minute" }, { l: "h", r: 89 }, { l: "hh", r: 21, d: "hour" }, { l: "d", r: 35 }, { l: "dd", r: 25, d: "day" }, { l: "M", r: 45 }, { l: "MM", r: 10, d: "month" }, { l: "y", r: 17 }, { l: "yy", d: "year" }], m2 = h3.length, c3 = 0; c3 < m2; c3 += 1) {
            var y3 = h3[c3];
            y3.d && (f2 = d3 ? t2(e3).diff(i3, y3.d, true) : i3.diff(e3, y3.d, true));
            var p2 = (r.rounding || Math.round)(Math.abs(f2));
            if (s3 = f2 > 0, p2 <= y3.r || !y3.r) {
              p2 <= 1 && c3 > 0 && (y3 = h3[c3 - 1]);
              var v2 = l3[y3.l];
              u && (p2 = u("" + p2)), a = "string" == typeof v2 ? v2.replace("%d", p2) : v2(p2, n3, y3.l, s3);
              break;
            }
          }
          if (n3) return a;
          var M = s3 ? l3.future : l3.past;
    ...
    !function(e2, n2) {
      ...
      return function(e2, n2, t2) {
        t2.updateLocale = function(e3, n3) {
          var o = t2.Ls[e3];
          if (o) return (n3 ? Object.keys(n3) : []).forEach(function(e4) {
            o[e4] = n3[e4];
          }), o;
        };
      };
...
// node_modules/@web3modal/wallet/node_modules/pino/browser.js
var require_browser2 = __commonJS({
  "node_modules/@web3modal/wallet/node_modules/pino/browser.js"(exports, module) {
    "use strict";
...
function clone(configObject) {
  ...
  function BigNumber2(v2, b2) {
    var alphabet, c3, caseChanged, e2, i2, isNum, len, str, x2 = this;
  ...
  BigNumber2.isBigNumber = function(v2) {
    ...
    var i2, n2, c3 = v2.c, e2 = v2.e, s3 = v2.s;
    ...
    } else if (c3 === null && e2 === null && (s3 === null || s3 === 1 || s3 === -1)) {
      return true;
    }
  ...
  BigNumber2.random = function() {
    ...
    return function(dp) {
      var a, b2, e2, k2, v2, i2 = 0, c3 = [], rand = new BigNumber2(ONE);
  ...
  convertBase = /* @__PURE__ */ function() {
    ...
    return function(str, baseIn, baseOut, sign, callerIsToString) {
      var alphabet, d2, e2, k2, r, x2, xc, y3, i2 = str.indexOf("."), dp = DECIMAL_PLACES, rm = ROUNDING_MODE;
      if (i2 >= 0) {
        k2 = POW_PRECISION;
        POW_PRECISION = 0;
        str = str.replace(".", "");
      ...
      r = rm < 4 ? (i2 != null || r) && (rm == 0 || rm == (x2.s < 0 ? 3 : 2)) : i2 > k2 || i2 == k2 && (rm == 4 || r || rm == 6 && xc[d2 - 1] & 1 || rm == (x2.s < 0 ? 8 : 7));
      if (d2 < 1 || !xc[0]) {
  ...
  div = /* @__PURE__ */ function() {
    ...
    return function(x2, y3, dp, rm, base) {
      var cmp, e2, i2, more, n2, prod, prodL, q, qc, rem, remL, rem0, xi, xL, yc0, yL, yz, s3 = x2.s == y3.s ? 1 : -1, xc = x2.c, yc = y3.c;
      if (!xc || !xc[0] || !yc || !yc[0]) {
  ...
  function maxOrMin(args, n2) {
    var k2, y3, i2 = 1, x2 = new BigNumber2(args[0]);
    for (; i2 < args.length; i2++) {
      y3 = new BigNumber2(args[i2]);
      if (!y3.s || (k2 = compare(x2, y3)) === n2 || k2 === 0 && x2.s === n2) {
        x2 = y3;
      }
    }
    return x2;
  ...
  function normalise(n2, c3, e2) {
    var i2 = 1, j = c3.length;
    for (; !c3[--j]; c3.pop()) ;
    for (j = c3[0]; j >= 10; j /= 10, i2++) ;
  ...
  function round(x2, sd, rm, r) {
    var d2, i2, j, k2, n2, ni, rd, xc = x2.c, pows10 = POWS_TEN;
    if (xc) {
      out: {
        ...
        (i2 > 0 ? j > 0 ? n2 / pows10[d2 - j] : 0 : xc[ni - 1]) % 10 & 1 || rm == (x2.s < 0 ? 8 : 7));
        if (sd < 1 || !xc[0]) {
          xc.length = 0;
          if (r) {
            sd -= x2.e + 1;
        ...
        if (i2 == 0) {
          ...
          xc[ni] = j > 0 ? mathfloor(n2 / pows10[d2 - j] % pows10[j]) * k2 : 0;
        }
        if (r) {
          for (; ; ) {
            if (ni == 0) {
  ...
  P.exponentiatedBy = P.pow = function(n2, m2) {
    ...
    if (!x2.c || !x2.c[0] || x2.c[0] == 1 && !x2.e && x2.c.length == 1 || !n2.c || !n2.c[0]) {
      y3 = new BigNumber2(Math.pow(+valueOf(x2), nIsBig ? n2.s * (2 - isOdd(n2)) : +valueOf(n2)));
  ...
  P.isEqualTo = P.eq = function(y3, b2) {
    return compare(this, new BigNumber2(y3, b2)) === 0;
  };
  P.isFinite = function() {
    return !!this.c;
  };
  P.isGreaterThan = P.gt = function(y3, b2) {
    return compare(this, new BigNumber2(y3, b2)) > 0;
  };
  P.isGreaterThanOrEqualTo = P.gte = function(y3, b2) {
    return (b2 = compare(this, new BigNumber2(y3, b2))) === 1 || b2 === 0;
  };
  P.isInteger = function() {
    return !!this.c && bitFloor(this.e / LOG_BASE) > this.c.length - 2;
  };
  P.isLessThan = P.lt = function(y3, b2) {
    return compare(this, new BigNumber2(y3, b2)) < 0;
  };
  P.isLessThanOrEqualTo = P.lte = function(y3, b2) {
    return (b2 = compare(this, new BigNumber2(y3, b2))) === -1 || b2 === 0;
  };
  P.isNaN = function() {
    return !this.s;
  ...
  P.multipliedBy = P.times = function(y3, b2) {
    var c3, e2, i2, j, k2, m2, xcL, xlo, xhi, ycL, ylo, yhi, zc, base, sqrtBase, x2 = this, xc = x2.c, yc = (y3 = new BigNumber2(y3, b2)).c;
    if (!xc || !yc || !xc[0] || !yc[0]) {
    ...
    for (i2 = ycL; --i2 >= 0; ) {
      ...
      for (k2 = xcL, j = i2 + k2; j > i2; ) {
        ...
        m2 = yhi * xlo + xhi * ylo;
        xlo = ylo * xlo + m2 % sqrtBase * sqrtBase + zc[j] + c3;
        c3 = (xlo / base | 0) + (m2 / sqrtBase | 0) + yhi * xhi;
        zc[j--] = xlo % base;
      }
      zc[j] = c3;
    }
  ...
  P.plus = function(y3, b2) {
    ...
    if (!xe || !ye) {
      ...
      if (!xc[0] || !yc[0]) return yc[0] ? y3 : new BigNumber2(xc[0] ? x2 : a * 0);
    }
    xe = bitFloor(xe);
    ye = bitFloor(ye);
    xc = xc.slice();
  ...
  P.squareRoot = P.sqrt = function() {
    var m2, n2, r, rep, t2, x2 = this, c3 = x2.c, s3 = x2.s, e2 = x2.e, dp = DECIMAL_PLACES + 4, half = new BigNumber2("0.5");
    if (s3 !== 1 || !c3 || !c3[0]) {
      return new BigNumber2(!s3 || s3 < 0 && (!c3 || c3[0]) ? NaN : c3 ? x2 : 1 / 0);
    }
    ...
    if (r.c[0]) {
      ...
      for (; ; ) {
        ...
        if (coeffToString(t2.c).slice(0, s3) === (n2 = coeffToString(r.c)).slice(0, s3)) {
          if (r.e < e2) --s3;
  ...
  P.toFraction = function(md) {
    var d2, d0, d1, d22, e2, exp, n2, n0, n1, q, r, s3, x2 = this, xc = x2.c;
    if (md != null) {
    ...
    n0.s = n1.s = x2.s;
    e2 = e2 * 2;
    r = div(n1, d1, e2, ROUNDING_MODE).minus(x2).abs().comparedTo(
  ...
  P.toString = function(b2) {
    var str, n2 = this, s3 = n2.s, e2 = n2.e;
    if (e2 === null) {
      if (s3) {
        str = "Infinity";
        if (s3 < 0) str = "-" + str;
      ...
      if (b2 == null) {
        ...
        intCheck(b2, 2, ALPHABET.length, "Base");
        str = convertBase(toFixedPoint(coeffToString(n2.c), e2, "0"), 10, b2, s3, true);
      }
      if (s3 < 0 && n2.c[0]) str = "-" + str;
    }
    return str;
  };
...
function coeffToString(a) {
  var s3, z3, i2 = 1, j = a.length, r = a[0] + "";
  for (; i2 < j; ) {
    s3 = a[i2++] + "";
...
function compare(x2, y3) {
  var a, b2, xc = x2.c, yc = y3.c, i2 = x2.s, j = y3.s, k2 = x2.e, l3 = y3.e;
  if (!i2 || !j) return null;
  a = xc && !xc[0];
  b2 = yc && !yc[0];
  ...
  if (!b2) return k2 > l3 ^ a ? 1 : -1;
  j = (k2 = xc.length) < (l3 = yc.length) ? k2 : l3;
  for (i2 = 0; i2 < j; i2++) if (xc[i2] != yc[i2]) return xc[i2] > yc[i2] ^ a ? 1 : -1;
  return k2 == l3 ? 0 : k2 > l3 ^ a ? 1 : -1;
}
...
var __decorate = function(decorators, target, key, desc) {
  ...
  else for (var i2 = decorators.length - 1; i2 >= 0; i2--) if (d2 = decorators[i2]) r = (c3 < 3 ? d2(r) : c3 > 3 ? d2(target, key, r) : d2(target, key)) || r;
...
var ConnectorController = {
    ...
    connectors.forEach((c3) => {
      if (!uniqueConnectors.find((uc) => uc.chain === c3.chain)) {
        uniqueConnectors.push({
          ...c3,
          name: ConstantsUtil.CHAIN_NAME_MAP[c3.chain]
        });
      }
    });
  ...
  getAuthConnector() {
    return state4.connectors.find((c3) => c3.type === "AUTH");
  },
  getAnnouncedConnectorRdns() {
    return state4.connectors.filter((c3) => c3.type === "ANNOUNCED").map((c3) => {
      var _a2;
  ...
  getConnector(id, rdns) {
    return state4.connectors.find((c3) => {
      var _a2;
...
// node_modules/@web3modal/wallet/node_modules/@walletconnect/logger/dist/index.es.js
...
var m = class {
  ...
  downloadLogsBlobInBrowser(e2) {
    const t2 = URL.createObjectURL(this.logsToBlob(e2)), o = document.createElement("a");
    o.href = t2, o.download = `walletconnect-logs-${(/* @__PURE__ */ new Date()).toISOString()}.txt`, document.body.appendChild(o), o.click(), document.body.removeChild(o), URL.revokeObjectURL(t2);
  }
};
var B = class {
  constructor(e2, t2 = l2) {
...
var f = (r, e2, t2) => e2 in r ? x(r, e2, { enumerable: true, configurable: true, writable: true, value: t2 }) : r[e2] = t2;
var i = (r, e2) => {
  for (var t2 in e2 || (e2 = {})) T.call(e2, t2) && f(r, t2, e2[t2]);
  if (p) for (var t2 of p(e2)) z2.call(e2, t2) && f(r, t2, e2[t2]);
  return r;
};
var g = (r, e2) => S(r, _(e2));
function k(r) {
...
function b(r, e2, t2 = n) {
  return r[t2] = e2, r;
}
function y2(r, e2 = n) {
  let t2 = "";
  return typeof r.bindings > "u" ? t2 = v(r, e2) : t2 = r.bindings().context || "", t2;
}
function w(r, e2, t2 = n) {
  const o = y2(r, t2);
  return o.trim() ? `${o}/${e2}` : e2;
}
function E(r, e2, t2 = n) {
  const o = w(r, e2, t2), a = r.child({ context: o });
  return b(a, o, t2);
}
function C(r) {
  var e2, t2;
  const o = new m((e2 = r.opts) == null ? void 0 : e2.level, r.maxSizeInBytes);
  return { logger: (0, import_pino.default)(g(i({}, r.opts), { level: "trace", browser: g(i({}, (t2 = r.opts) == null ? void 0 : t2.browser), { write: (a) => o.write(a) }) })), chunkLoggerController: o };
}
function I(r) {
  var e2;
  const t2 = new B((e2 = r.opts) == null ? void 0 : e2.level, r.maxSizeInBytes);
  return { logger: (0, import_pino.default)(g(i({}, r.opts), { level: "trace" }), t2), chunkLoggerController: t2 };
}
function A(r) {
...
//# sourceMappingURL=chunk-JTYCVBNN.js.map
