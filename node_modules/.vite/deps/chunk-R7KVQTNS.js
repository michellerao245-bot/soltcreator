    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await (() => {
          try {
            return import("./dist-M3HA2OLB.js");
          } catch {
    ...
    async getProvider() {
      if (!walletProvider) {
        const { createCoinbaseWalletSDK } = await (() => {
          try {
            return import("./dist-Q4YLCSCY.js");
          } catch {
      ...
      if (!provider_) {
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await (() => {
            try {
              return import("./dist-34VLV466.js");
            } catch {
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        const { EthereumProvider } = await (() => {
          try {
            return import("./index.es-IOWDUG3N.js");
          } catch {
...
@noble/curves/esm/ed25519.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-R7KVQTNS.js.map
