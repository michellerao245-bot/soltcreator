...
(function(claim4) {
  async function inner(action, client, parameters) {
    const { account = client.account, chain = client.chain, to: to2, receipt, ...rest } = parameters;
    if (!account)
      throw new Error("`account` is required");
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await (() => {
          try {
            return import("./dist-QKFQ2VZ2.js");
          } catch {
    ...
    async getProvider() {
      if (!walletProvider) {
        const { createCoinbaseWalletSDK } = await (() => {
          try {
            return import("./dist-KJ6NOP5O.js");
          } catch {
      ...
      if (!provider_) {
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await (() => {
            try {
              return import("./dist-OSTJGG34.js");
            } catch {
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        const { EthereumProvider } = await (() => {
          try {
            return import("./dist-MWEFOWJR.js");
          } catch {
...
@noble/curves/esm/ed25519.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=exports-FO7HGME2.js.map
