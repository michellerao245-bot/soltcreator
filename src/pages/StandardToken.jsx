...
const StandardToken = () => {
  ...
  const FEE_AMOUNT = "2000"; // Updated fee as per your configuration
  ...
  const handleDeploy = async (e) => {
    ...
    try {
      setLoading(true);
      setDeployMessage("🚀 Starting standard deployment...");
      setTokenAddress("");
      ...
      // 2. Deploy Standard Token
      setDeployMessage("⏳ Deploying Standard Token...");
      ...
      setDeployMessage("✅ Standard Token Deployed Successfully!");
      ...
      <div style={styles.card}>
        ...
        <form onSubmit={handleDeploy}>
          ...
          <button style={styles.button} disabled={loading}>
            {loading ? "⏳ Processing..." : "Deploy Standard Token"}
          </button>
        </form>
...
const styles = {
  ...
  title: { textAlign: "center", marginBottom: "25px", fontSize: '22px', fontWeight: 'bold', color: '#60a5fa' },
  ...
  button: { width: "100%", padding: "14px", background: "linear-gradient(90deg, #3b82f6, #60a5fa)", border: "none", borderRadius: "8px", color: "#fff", fontWeight: "bold", cursor: "pointer" },
  ...
  resultBox: { marginTop: "20px", background: "#0a1120", padding: "15px", borderRadius: "8px", border: "1px dashed #60a5fa" },
