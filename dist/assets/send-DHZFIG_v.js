import{dw as b,fD as d,g4 as u,dy as x,fd as v,dN as H,a7 as O,Q as g,Y as V,bA as a,cO as c,fE as L,bu as h,bd as E,bU as I,b7 as K,bE as y,a0 as J,E as X,B as G,ge as Y,dQ as Q,fK as Z,x as M,ag as q,aj as ee}from"./index-CzDVH4U8.js";import"./index-DDAaGeCI.js";import"./index-CTEiaOJ2.js";import{S as P}from"./SwapController-CWEwFoTM.js";import"react-is";const te=b`
  :host {
    width: 100%;
    height: 100px;
...
`;var B=function(e,t,i,o){var r=arguments.length,n=r<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,i):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,i,o);else for(var l=e.length-1;l>=0;l--)(s=e[l])&&(n=(r<3?s(n):r>3?s(t,i,n):s(t,i))||n);return r>3&&n&&Object.defineProperty(t,i,n),n};let T=class extends v{constructor(){super(...arguments),this.text=""}render(){return c`<wui-text variant="lg-regular" color="primary">${this.text}</wui-text>
      ${this.imageTemplate()}`}imageTemplate(){return this.address?c`<wui-avatar address=${this.address} .imageSrc=${this.imageSrc}></wui-avatar>`:this.imageSrc?c`<wui-image src=${this.imageSrc}></wui-image>`:c`<wui-icon size="lg" color="inverse" name="networkPlaceholder"></wui-icon>`}};T.styles=[Y,Q,oe];B([d({type:String})],T.prototype,"text",void 0);B([d({type:String})],T.prototype,"address",void 0);B([d({type:String})],T.prototype,"imageSrc",void 0);T=B([x("wui-preview-item")],T);const se=b`
  :host {
    display: flex;
