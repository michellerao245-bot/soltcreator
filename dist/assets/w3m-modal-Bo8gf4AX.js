import{b7 as k,bx as le,bu as c,Y as pe,dw as v,ge as V,dy as f,fd as g,cO as d,fD as l,fK as $,s as H,g4 as u,dQ as me,Q as w,he as B,B as U,z as fe,a2 as F,aj as K,bf as A,Z as M,fe as we,bE as E,t as z,ar as oe,bK as be,bU as ce,fh as ge,r as ye}from"./index-CzDVH4U8.js";import{P as D}from"./index-BNz1318v.js";import{S as ve}from"./SwapController-CWEwFoTM.js";import"react-is";const de={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){k.shake();return}if(await le.isSIWXCloseDisabled()){k.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&pe.disconnect(),k.close()}},xe=v`
  :host {
    display: block;
