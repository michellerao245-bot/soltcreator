...
import{fe as J,fD as a,fd as m,cO as h,hg as d,h7 as ee,gg as oe,cC as c,dO as re,fK as L}from"./index-CzDVH4U8.js";import{U as w,V as p,D as x,G as Z}from"./core-uSws1MXB.js";const G=".",k={getSpacingStyles(e,t){if(Array.isArray(e))return e[t]?`var(--apkt-spacing-${e[t]})`:void 0;if(typeof e=="string")return`var(--apkt-spacing-${e})`},getFormattedDate(e){return new Intl.DateTimeFormat("en-US",{month:"short",day:"numeric"}).format(e)},formatCurrency(e=0,t={}){const o=Number(e);return isNaN(o)?"$0.00":new Intl.NumberFormat("en-US",{style:"currency",currency:"USD",minimumFractionDigits:2,maximumFractionDigits:2,...t}).format(o)},getHostName(e){try{return new URL(e).hostname}catch{return""}},getTruncateString({string:e,charsStart:t,charsEnd:o,truncate:r}){return e.length<=t+o?e:r==="end"?`${e.substring(0,t)}...`:r==="start"?`...${e.substring(e.length-o)}`:`${e.substring(0,Math.floor(t))}...${e.substring(e.length-Math.floor(o))}`},generateAvatarColors(e){const o=e.toLowerCase().replace(/^0x/iu,"").replace(/[^a-f0-9]/gu,"").substring(0,6).padEnd(6,"0"),r=this.hexToRgb(o),n=getComputedStyle(document.documentElement).getPropertyValue("--w3m-border-radius-master"),l=100-3*Number(n==null?void 0:n.replace("px","")),s=`${l}% ${l}% at 65% 40%`,z=[];for(let N=0;N<5;N+=1){const D=this.tintColor(r,.15*N);z.push(`rgb(${D[0]}, ${D[1]}, ${D[2]})`)}return`
    --local-color-1: ${z[0]};
    --local-color-2: ${z[1]};
    --local-color-3: ${z[2]};
    --local-color-4: ${z[3]};
...
`,Pe=d`<svg width="32" height="32" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
  <g clip-path="url(#a)">
...
`;var T=function(e,t,o,r){var n=arguments.length,i=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(l=e[s])&&(i=(n<3?l(i):n>3?l(t,o,i):l(t,o))||i);return n>3&&i&&Object.defineProperty(t,o,i),i};const je={primary:p.tokens.theme.textPrimary,secondary:p.tokens.theme.textSecondary,tertiary:p.tokens.theme.textTertiary,invert:p.tokens.theme.textInvert,error:p.tokens.core.textError,success:p.tokens.core.textSuccess,warning:p.tokens.core.textWarning,"accent-primary":p.tokens.core.textAccentPrimary};let E=class extends m{constructor(){super(...arguments),this.variant="md-regular",this.color="inherit",this.align="left",this.lineClamp=void 0,this.display="inline-flex"}render(){const t={[`wui-font-${this.variant}`]:!0,[`wui-line-clamp-${this.lineClamp}`]:!!this.lineClamp};return this.style.cssText=`
      ...
      `,h`<slot class=${re(t)}></slot>`}};E.styles=[w,Be];T([a()],E.prototype,"variant",void 0);T([a()],E.prototype,"color",void 0);T([a()],E.prototype,"align",void 0);T([a()],E.prototype,"lineClamp",void 0);T([a()],E.prototype,"display",void 0);E=T([v("wui-text")],E);const We=x`
  :host {
    display: inline-flex;
    justify-content: center;
    align-items: center;
...
`;var H=function(e,t,o,r){var n=arguments.length,i=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(l=e[s])&&(i=(n<3?l(i):n>3?l(t,o,i):l(t,o))||i);return n>3&&i&&Object.defineProperty(t,o,i),i};let S=class extends m{constructor(){super(...arguments),this.size="md",this.name="",this.installed=!1,this.badgeSize="xs"}render(){let t="1";return this.size==="lg"?t="4":this.size==="md"?t="2":this.size==="sm"&&(t="1"),this.style.cssText=`
   ...
   `,this.dataset.size=this.size,this.imageSrc&&(this.dataset.image="true"),this.walletIcon&&(this.dataset.walletIcon=this.walletIcon),h`
    ...
    `}templateVisual(){return this.imageSrc?h`<wui-image src=${this.imageSrc} alt=${this.name}></wui-image>`:this.walletIcon?h`<wui-icon size="md" color="default" name=${this.walletIcon}></wui-icon>`:h`<wui-icon
      ...
      color="inherit"
      name="wallet"
    ></wui-icon>`}};S.styles=[w,Ue];H([a()],S.prototype,"size",void 0);H([a()],S.prototype,"name",void 0);H([a()],S.prototype,"imageSrc",void 0);H([a()],S.prototype,"walletIcon",void 0);H([a({type:Boolean})],S.prototype,"installed",void 0);H([a()],S.prototype,"badgeSize",void 0);S=H([v("wui-wallet-image")],S);const Ne=x`
  :host {
    position: relative;
    border-radius: ${({borderRadius:e})=>e[2]};
    width: 40px;
...
`;var ie=function(e,t,o,r){var n=arguments.length,i=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(l=e[s])&&(i=(n<3?l(i):n>3?l(t,o,i):l(t,o))||i);return n>3&&i&&Object.defineProperty(t,o,i),i};const X=4;let q=class extends m{constructor(){super(...arguments),this.walletImages=[]}render(){const t=this.walletImages.length<X;return h`${this.walletImages.slice(0,X).map(({src:o,walletName:r})=>h`
          ...
          ></wui-wallet-image>
        `)}
    ${t?[...Array(X-this.walletImages.length)].map(()=>h` <wui-wallet-image size="sm" name=""></wui-wallet-image>`):null} `}};q.styles=[w,Ne];ie([a({type:Array})],q.prototype,"walletImages",void 0);q=ie([v("wui-all-wallets-image")],q);const Ge=x`
  :host {
    display: flex;
    justify-content: center;
    align-items: center;
...
`;var Q=function(e,t,o,r){var n=arguments.length,i=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(l=e[s])&&(i=(n<3?l(i):n>3?l(t,o,i):l(t,o))||i);return n>3&&i&&Object.defineProperty(t,o,i),i};let B=class extends m{constructor(){super(...arguments),this.color="primary",this.size="lg"}render(){const t={primary:p.tokens.theme.textPrimary,secondary:p.tokens.theme.textSecondary,tertiary:p.tokens.theme.textTertiary,invert:p.tokens.theme.textInvert,error:p.tokens.core.textError,warning:p.tokens.core.textWarning,"accent-primary":p.tokens.core.textAccentPrimary};return this.style.cssText=`
      ...
      <path
        ...
        fill="currentColor"
      />
    </svg>`}};B.styles=[w,Xe];Q([a()],B.prototype,"color",void 0);Q([a()],B.prototype,"size",void 0);B=Q([v("wui-loading-spinner")],B);const Ke=x`
  :host {
    width: var(--local-width);
  }
...
`;var O=function(e,t,o,r){var n=arguments.length,i=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(l=e[s])&&(i=(n<3?l(i):n>3?l(t,o,i):l(t,o))||i);return n>3&&i&&Object.defineProperty(t,o,i),i};const Je={lg:"lg-regular-mono",md:"md-regular-mono",sm:"sm-regular-mono"},Qe={lg:"md",md:"md",sm:"sm"};let P=class extends m{constructor(){super(...arguments),this.size="lg",this.disabled=!1,this.fullWidth=!1,this.loading=!1,this.variant="accent-primary"}render(){this.style.cssText=`
    ...
    `}loadingTemplate(){if(this.loading){const t=Qe[this.size],o=this.variant==="neutral-primary"||this.variant==="accent-primary"?"invert":"primary";return h`<wui-loading-spinner color=${o} size=${t}></wui-loading-spinner>`}return null}};P.styles=[w,Z,Ke];O([a()],P.prototype,"size",void 0);O([a({type:Boolean})],P.prototype,"disabled",void 0);O([a({type:Boolean})],P.prototype,"fullWidth",void 0);O([a({type:Boolean})],P.prototype,"loading",void 0);O([a()],P.prototype,"variant",void 0);O([a()],P.prototype,"textVariant",void 0);P=O([v("wui-button")],P);const et=x`
  button {
    border: none;
...
`;var U=function(e,t,o,r){var n=arguments.length,i=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(l=e[s])&&(i=(n<3?l(i):n>3?l(t,o,i):l(t,o))||i);return n>3&&i&&Object.defineProperty(t,o,i),i};let R=class extends m{constructor(){super(...arguments),this.width="",this.height="",this.variant="default",this.rounded=!1}render(){return this.style.cssText=`
      width: ${this.width};
      height: ${this.height};
    `,this.dataset.rounded=this.rounded?"true":"false",h`<slot></slot>`}};R.styles=[ot];U([a()],R.prototype,"width",void 0);U([a()],R.prototype,"height",void 0);U([a()],R.prototype,"variant",void 0);U([a({type:Boolean})],R.prototype,"rounded",void 0);R=U([v("wui-shimmer")],R);const rt="https://reown.com",nt=x`
  .reown-logo {
    height: 24px;
  }
...
`;var at=function(e,t,o,r){var n=arguments.length,i=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(l=e[s])&&(i=(n<3?l(i):n>3?l(t,o,i):l(t,o))||i);return n>3&&i&&Object.defineProperty(t,o,i),i};let K=class extends m{render(){return h`
      <a
    ...
    `}};K.styles=[w,Z,nt];K=at([v("wui-ux-by-reown")],K);const _t=d`<svg  viewBox="0 0 48 54" fill="none">
  <path
